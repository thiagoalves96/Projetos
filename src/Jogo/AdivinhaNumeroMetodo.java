...
public class AdivinhaNumeroMetodo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = tentativas; i > -1; i--) {

				if (palpite == sorteado) {

					System.out.println("\nParabéns você ACERTOU na sua " + (i + 1) + "/3 tentativas.");
					break;
					...
					System.out.println(
							"Dica: O numero é menor do que 50. Mas você tem apenas " + (i + 1) + " Chance(s).");
					...
					System.out.println("Dica: O numero é maior do que 50. Mas você tem apenas " + (i + 1) + " Chance.");
					...
					System.out.println("\nSem dicas desta vez. :( ");
					System.out.println("Você tem apenas " + i + " Chance.");
					System.out.print("Digite o seu palpite novamente: ");
